      ...
      <div className={`${generalClasses.container} ${classes.footer__content}`}>
        ...
        <div className={classes.footer__3column}>
          ...
          <ul className={classes.socialMedia}>
            <li>
              <a href="/">
                <Svg classElement={classes.svgSocMedia} name="vk" />
              </a>
            </li>
            <li>
              <a href="/">
                <Svg classElement={classes.svgSocMedia} name="instagram" />
              </a>
            </li>
            <li>
              <a href="/">
                <Svg classElement={classes.svgSocMedia} name="facebook" />
              </a>
            </li>
            <li>
              <a href="/">
                <Svg classElement={classes.svgSocMedia} name="youtube" />
              </a>
            </li>
          </ul>
          <p className={classes.column3__text}>
